            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="text-wrap bg-light border">
                            <pre class="bg-black text-light text-wrap">
                                <code>
                                    {{ accessToken }}
                                </code>
                            </pre>
...
export default {
    ...
    mounted() {
        ...
        this.modalCreate = new Modal(
            document.getElementById("modal-create-token")
        );
        this.modalToken = new Modal(
            document.getElementById("modal-access-token")
        );
    },
